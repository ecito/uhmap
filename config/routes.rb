ActionController::Routing::Routes.draw do |map|
  ...
  map.connect 'interests/list', :controller => 'interests', :action => 'list'
  map.resources :interests
  map.connect 'categories', :controller => 'categories'
#  map.resources :buildings

  # The priority is based upon order of creation: first created -> highest priority.

	map.connect 'photos/*path', :controller => 'buildings', :action => 'photos'
